...
for a good reason, see [autostart.md](autostart.md)) makes the unit die CLEAN, so nothing shows in
...
- **Java**, for CurseForge. It is dead config: see [curseforge.md](curseforge.md).
- **wrangler**, above.

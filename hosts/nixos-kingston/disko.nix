...
# chegar nele está em docs/historico.md (o módulo que criava o repo já foi apagado).
#
...
# IMPERMANÊNCIA (docs/historico.md, entrada de 30/07 — raiz efêmera + lista explícita do

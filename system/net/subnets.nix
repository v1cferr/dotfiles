...

{
  options.my.net = {
    ...
    # SEPARATE from the LAN on purpose: the firewall that keeps Sunshine reachable trusts ONLY this
    # one, so merging the two would open it to the whole home network without anybody noticing.
